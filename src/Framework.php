...
class Framework {
    ...
    static function run() {
        ...
        try {
            ...
            if($result == null) throw new Exception('Route not Found', 'route/not-found', 404);
            ...
            if($methodRef == null) throw new Exception('Method reference not found', 'route/method-not-found', 404);
